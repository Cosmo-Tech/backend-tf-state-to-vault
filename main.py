...
def main():
    ...
    parser_addsecrets = secret_subparsers.add_parser(
        'add', 
    ...
    parser_deletesecrets = secret_subparsers.add_parser(
        'delete',  
        help='Delete an existing secret'
    )

    # Add the 'policies' subcommand parser
    parser_policies = subparsers.add_parser(
        'policies', 
        help='Operations related to policies management'
    )
    ...
    parser_addpolicies = policies_subparsers.add_parser(
        'add', 
    ...
    parser_deletepolicies = policies_subparsers.add_parser(
        'delete', 
        help='Delete an existing policy'
    )
    ...
    parser_updatepolicies = policies_subparsers.add_parser(
        'update', 
        help='update an existing policy'
    )
    ...
    parser_backup = data_subparsers.add_parser(
        'backup', 
        help='Backup data config'
    )
    # 'import' subcommand under 'data'
    parser_import = data_subparsers.add_parser(
        'import', 
        help='Import data config'
    )
    parser_import.add_argument(
        '--platform-id-to', 
        required=True, 
        help='Platform ID to import the secrets into'
    )
    parser_import.add_argument(
        '--backup-file', 
        required=True, 
